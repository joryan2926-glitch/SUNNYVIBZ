...
const routes = [
  ...
  { path: "/espaces", priority: 0.88, changeFrequency: "weekly" as const },
  { path: "/communaute", priority: 0.87, changeFrequency: "weekly" as const },
  ...
  { path: "/marketplace/portrait-photo-artistique", priority: 0.78, changeFrequency: "weekly" as const },
  { path: "/marketplace/oeuvre-originale-sur-commande", priority: 0.78, changeFrequency: "weekly" as const },
  { path: "/marketplace/animation-atelier-creatif", priority: 0.78, changeFrequency: "weekly" as const },
  { path: "/marketplace/stand-exposant-sunny-friday", priority: 0.78, changeFrequency: "weekly" as const },
